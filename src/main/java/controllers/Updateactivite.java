...
public class Updateactivite {
    ...
    public void initData(int id){
        ...
        java.util.Date utilDateDebut = new java.util.Date(dateDebutFromDatabase.getTime());
        java.util.Date utilDateFin = new java.util.Date(dateFinFromDatabase.getTime());
